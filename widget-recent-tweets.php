		...
		$out = '<ul class="gabfire-tweets">';
			if ($tweets_base == 'hashtag'){		
				...
				foreach($reply['statuses'] as $message) {
					...
					//Serach links (i.e hashtag)
					$msg = preg_replace('/(^|\s)#(\w*[a-zA-Z_]+\w*)/', '\1<a href="http://twitter.com/search?q=%23\2&mode=relevance&src=typd" class="twitter-link" '.$link_target.'>#\2</a>', $msg);
